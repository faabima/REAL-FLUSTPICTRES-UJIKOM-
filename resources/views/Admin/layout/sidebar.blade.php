            ...
            <div class="flex-1 px-3 bg-white divide-y space-y-1">
                <ul class="space-y-2 pb-2">
                    <li>
                      ...
                      <div class="relative">
                         ...
                         <input type="text" name="email" id="mobile-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full pl-10 p-2.5" placeholder="Search">
                      </div>
                   </form> --}}
                    </li>
                    <li>
                    ...
                    <li>
                        <a
                            href="/tambahadmin"class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">New Admin</span>
                    ...
                    <li>
                        <a href="/kotakmasuk"
                            ...
                            <img src="/assets/logo.png" class="h-6 mr-2" alt="Flustpicture Logo">
                            <span class="ml-3">Apply User Message</span>
                        </a>
                    </li>
                    <li>
                ...
                <div class="space-y-2 pt-2">
                   ...
                   <span class="ml-4">Upgrade to Pro</span>
                    ...
                    <span class="ml-3">Message User</span>
                </a> --}}
                   ...
                   <span class="ml-3">Components</span>
                    ...
                    <a href="/profiladmin"
                        class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                        <img src="/admin/{{ old('foto_profil', Auth::User()->foto_profil) }}" alt="User Avatar"
                            class="w-8 h-8 rounded-full">
                        <span class="ml-3 flex-1 whitespace-nowrap">Profile</span>
                    </a>
                    <a href="/passwordadmin"
                        class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                        <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="ml-3 flex-1 whitespace-nowrap">Update Password</span>
                    </a>
                    <a href="/logoutadmin"
                        class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                        <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
