        ...
        <main class="w-full">
            <div class="bg-gray-100">
                <section
                    ...
                    <div class="h-full absolute top-0 left-0 z-0">
                        <img src="/assets/logo.png" alt="" class="w-full h-full object-cover opacity-20">
                    </div>
                    <div class="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
                        <div>
                            ...
                            <p class="text-blue-100 text-xl md:text-2xl leading-snug mt-4">
                                Website galeri foto, ruangan yang mempamerkan karya-karya fotografi dari para fotografer.
                            </p>
                        </div>
                    </div>
                </section>
            ...
            <section
                ...
                <div class="md:flex md:items-center md:justify-center">
                    <h2 class="text-xl font-bold text-white">@Flustpicture<br class="block md:hidden">Report
                        WhatsApp on: +62 562-789-1935</h2>
                    <a href="#"
            ...
            <footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
                <div class="flex flex-col md:flex-row">
                    <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                        <h3 class="font-bold text-2xl">Flustpicture 2024</h3>
                        <p class="text-gray-400">@fabimafadzillah.
                        </p>    
                    </div>

                    <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                        <h5 class="uppercase tracking-wider font-semibold text-gray-500">Photos</h5>
                        <ul class="mt-4">
                            <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">fotografer</a></li>
                            <li class="mt-2"><a href="#" title=""
                                    class="opacity-75 hover:opacity-100">environment</a></li>
                            <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Information</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                        ...
                        <p class="text-sm text-gray-400 mt-12">© 2024 Production. <br class="hidden lg:block">All Rights
                            Reserved.
                        </p>
                    </div>
                </div>
